    ...
    angular.module('photoshop')
        .directive('layer', ['currentlySelected', function (currentlySelected) {
            return {
                ...
                //template: 'layer!',
                templateUrl:'/photoshop-angular/partials/directives/photoshop/layer.html',
    ...
    angular.module('photoshop')
        .directive('photoCanvas', ['currentlySelected', function (currentlySelected) {
            return {
                ...
                replace: false,
                bindToController: true,
                templateUrl:'/photoshop-angular/partials/directives/photoshop/photoCanvas.html',
...
(function () {
    ...
    var properties = function () {
        return {
            ...
            bindToController: true,
            templateUrl:'/photoshop-angular/partials/directives/photoshop/properties.html',
...
(function () {
    ...
    angular.module('photoshop').directive('selectOne', function () {
        return {
            ...
            bindToController: true,
            templateUrl:'/photoshop-angular/partials/directives/photoshop/selectOne.html',
...
(function () {
    ...
    var phoTab = function () {
        return {
            ...
            transclude: true,
            bindToController: true,
            templateUrl:'/photoshop-angular/partials/directives/photoshop/tab.html',
            controller: function ($scope) {
                var vm = this;
